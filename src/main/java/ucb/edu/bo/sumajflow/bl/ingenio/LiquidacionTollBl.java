...
public class LiquidacionTollBl {
    ...
    public Liquidacion crearLiquidacionToll(
        ...
        // Uso de balanza (por cada camión)
        ...
        // Convertir servicios adicionales a USD
        ...
        Liquidacion liquidacion = Liquidacion.builder()
                ...
                .moneda("BOB")
                .estado("esperando_aprobacion_socio")
        ...
        notificarSocio(liquidacion, socio, ingenio);

        log.info("✅ Liquidación de Toll creada - ID: {}, Total: {} BOB",
    ...
    private void notificarSocio(Liquidacion liquidacion, Socio socio, IngenioMinero ingenio) {
        ...
        notificacionBl.crearNotificacion(
                socioUsuarioId,
                "info",
                "Liquidación de Toll generada",
                String.format("Se ha generado la liquidación de servicio de procesamiento por %.2f BOB. " +
                        "Debe aprobar y realizar el pago.", liquidacion.getValorNetoBob()),
                metadata
        );
    }
