...
@RestController
@RequestMapping("/comercializadora/balanza")
@CrossOrigin(origins = "*")
@RequiredArgsConstructor
public class BalanzaComercializadoraController {

    private final BalanzaBl balanzaBl;
    private final JwtUtil jwtUtil;

    /**
     * Obtiene la balanza de la comercializadora
     * GET /api/comercializadora/balanza
     */
    @GetMapping
    public ResponseEntity<Map<String, Object>> obtenerBalanza(@RequestHeader("Authorization")  String token) {
        ...
        try {
            ...
            BalanzaResponseDto balanza = balanzaBl.obtenerBalanzaComercializadora(usuarioId);
    ...
    /**
     * Actualiza la balanza de la comercializadora
     * PUT /api/comercializadora/balanza
     */
    @PutMapping
    public ResponseEntity<Map<String, Object>> actualizarBalanza(
        ...
        try {
            ...
            BalanzaResponseDto balanza = balanzaBl.actualizarBalanzaComercializadora(
                    usuarioId,
                    updateDto,
                    ipOrigen,
                    "PUT",
                    "/api/comercializadora/balanza"
            );
