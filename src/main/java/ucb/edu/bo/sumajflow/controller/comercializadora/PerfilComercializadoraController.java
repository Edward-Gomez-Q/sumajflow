...
/**
 * Controlador de perfil para usuarios tipo COMERCIALIZADORA
 */
@RestController
@RequestMapping("/comercializadora/perfil")
@CrossOrigin(origins = "*")
@RequiredArgsConstructor
public class PerfilComercializadoraController {
     ...
     * PUT /comercializadora/perfil/datos-personales
     */
     ...
     * PUT /comercializadora/perfil/correo
     */
    @PutMapping("/correo")
     ...
     * PUT /comercializadora/perfil/contrasena
     */
     ...
     * PUT /comercializadora/perfil/direccion
     */
