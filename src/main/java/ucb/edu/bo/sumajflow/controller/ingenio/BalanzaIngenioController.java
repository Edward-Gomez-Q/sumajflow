...
@RestController
@RequestMapping("/ingenio/balanza")
@CrossOrigin(origins = "*")
@RequiredArgsConstructor
public class BalanzaIngenioController {

    private final BalanzaBl balanzaBl;
    private final JwtUtil jwtUtil;

    /**
     * Obtiene la balanza del ingenio
     * GET /api/ingenio/balanza
     */
    @GetMapping
    public ResponseEntity<Map<String, Object>> obtenerBalanza(
        ...
        try {
            ...
            BalanzaResponseDto balanza = balanzaBl.obtenerBalanzaIngenio(usuarioId);
    ...
    /**
     * Actualiza la balanza del ingenio
     * PUT /api/ingenio/balanza
     */
    @PutMapping
    public ResponseEntity<Map<String, Object>> actualizarBalanza(
        ...
        try {
            ...
            BalanzaResponseDto balanza = balanzaBl.actualizarBalanzaIngenio(
                    usuarioId,
                    updateDto,
                    ipOrigen,
                    "PUT",
