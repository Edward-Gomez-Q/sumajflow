...
@RestController
@RequestMapping("/ingenio/notificaciones")
@CrossOrigin(origins = "*")
@RequiredArgsConstructor
public class NotificacionesIngenioController {
    private final NotificacionBl notificacionBl;
    private final JwtUtil jwtUtil;

    /**
     * Obtener todas las notificaciones con filtros
     * GET /ingenio/notificaciones?soloNoLeidas=true&tipo=info&page=0&size=20
     */
    @GetMapping
     ...
     * GET /ingeino/notificaciones/count
     */
    @GetMapping("/count")
     ...
     * PUT /ingenio/notificaciones/{id}/leer
     */
    @PutMapping("/{id}/leer")
     ...
     * PUT /ingenio/notificaciones/leer-todas
     */
     ...
     * DELETE /ingenio/notificaciones/{id}
     */
    @DeleteMapping("/{id}")
