...
/**
 * Controlador de perfil para usuarios tipo INGENIO
 */
@RestController
@RequestMapping("/ingenio/perfil")
@CrossOrigin(origins = "*")
@RequiredArgsConstructor
public class PerfilIngenioController {
     ...
     * PUT /ingenio/perfil/datos-personales
     */
