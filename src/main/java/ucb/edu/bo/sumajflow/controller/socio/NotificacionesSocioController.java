...
@RestController
@RequestMapping("/socio/notificaciones")
@CrossOrigin(origins = "*")
@RequiredArgsConstructor
public class NotificacionesSocioController {
     ...
     * GET /socio/notificaciones?soloNoLeidas=true&tipo=info&page=0&size=20
     */
    @GetMapping
     ...
     * GET /socio/notificaciones/count
     */
    @GetMapping("/count")
     ...
     * PUT /socio/notificaciones/{id}/leer
     */
    @PutMapping("/{id}/leer")
     ...
     * PUT /socio/notificaciones/leer-todas
     */
     ...
     * DELETE /socio/notificaciones/{id}
     */
    @DeleteMapping("/{id}")
