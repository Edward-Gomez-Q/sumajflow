...
/**
 * Controlador de perfil para usuarios tipo TRANSPORTISTA
 * NOTA: Los transportistas tienen restricciones para editar CI y número de celular
 */
@RestController
@RequestMapping("/transportista/perfil")
@CrossOrigin(origins = "*")
...
public class PerfilTransportistaController {
     ...
     * PUT /transportista/perfil/correo
     */
    @PutMapping("/correo")
     ...
     * PUT /transportista/perfil/contrasena
     */
     ...
     * PUT /transportista/perfil/direccion
     */
