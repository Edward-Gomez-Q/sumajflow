...
@NoArgsConstructor
@AllArgsConstructor
public class LoteDetalleIngenioDto {
    ...
    private String ingenioTelefono;
    private BigDecimal ingenioAlmacenLatitud;
    private BigDecimal ingenioAlmacenLongitud;
    private BigDecimal ingenioBalanzaLatitud;
    private BigDecimal ingenioBalanzaLongitud;
